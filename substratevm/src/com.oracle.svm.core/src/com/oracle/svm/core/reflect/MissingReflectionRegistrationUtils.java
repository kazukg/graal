        ...
        switch (missingRegistrationReportingMode()) {
            ...
            case Warn -> {
                ...
                if (seenOutputs.isEmpty()) {
                    ...
                    System.out.println("Note: this run will print partial stack traces of the locations where a MissingReflectionRegistrationError is thrown when the " +
                                    SubstrateOptions.ThrowMissingRegistrationErrors + " option is set. The trace stops at the first entry of JDK code and provides 4 lines of context.");
                }
